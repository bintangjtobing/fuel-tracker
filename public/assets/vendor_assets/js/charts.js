...
function chartjsLineChartForcast(
    selector,
    label = "",
    startGradient = "#3478B112",
    endGradient = "#3478B102",
    bColor = "#20C997",
                    ...
                    datasets: [
                        {
                            ...
                            // backgroundColor: bgColor,
                            borderColor: bColor,
                            pointHoverBackgroundColor: "#3478B1",
...
/* line chart four */
function chartjsLineChartFourExtra(
    selector,
    bcolor = "#FA8B0C",
    height = "95",
    dataCur,
        ...
        var chart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [
                    {
                        data: dataG,
                        backgroundColor: "#3478B180",
                        hoverBackgroundColor: "#3478B1",
                        label: "Gained",
                    },
                    // {
                    //   data: dataL,
...
function chartjsBarChartTransparent(
    selector,
    dataCIn,
    DataCOut,
...
function chartjsBarChartCashflowExtra(
    selector,
    dataCIn,
    DataCOut,
    labels,
    label = "Bar chart Cash Flow"
) {
    var ctx = document.getElementById(selector);
    Chart.defaults.global.defaultFontColor = "#868EAE";
    if (ctx) {
...
function chartjsBarChartCashflow(
    selector,
    dataCIn,
    DataCOut,
    labels,
...
chartJsBarChartThree("mychart8", "#3478B120", "#3478B1", "Order");
...
chartJsBarChartFour("mychart13", "#3478B120", "#3478B1", "New Deals");
        ...
        var chart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [
                    {
                        data: data,
                        backgroundColor: ["#20C997", "#3478B1", "#FA8B0C"],
                        total: "9,283",
                    },
                ],
            },
...
chartjsDoughnut("chartDoughnut2", "150", (data = [4483, 5870, 2420]));

$("#se_device-today-tab").on("shown.bs.tab", function () {
    chartjsDoughnut("chartDoughnut2T", "146", (data = [83, 70, 20]));
    $("#se_device-today-tab").off();
});

$("#se_device-week-tab").on("shown.bs.tab", function () {
    chartjsDoughnut("chartDoughnut2W", "146", (data = [483, 870, 420]));
    $("#se_device-week-tab").off();
});

$("#se_device-year-tab").on("shown.bs.tab", function () {
    chartjsDoughnut("chartDoughnut2Y", "146", (data = [9483, 13870, 15420]));
...
$("#rb_device-week-tab").on("shown.bs.tab", function () {
    chartjsDoughnut("chartDoughnut3W", "146", (data = [483, 870, 420]));
...
chartjsDoughnutExtra("chartDoughnut2Extra", "150", (data = [4483, 5870, 2420]));

$("#se_device-today-tab").on("shown.bs.tab", function () {
    chartjsDoughnutExtra("chartDoughnut2TExtra", "146", (data = [83, 70, 20]));
    $("#se_device-today-tab").off();
});
